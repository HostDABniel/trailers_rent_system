...
<div class="campitem">
  ...
  <div class="campe dosporx2">  <strong>Nombre: </strong><?php echo $row["nombre"]." ".$row["apellido"];?></div>
    <div class="campe dosporx2">
    <input type="hidden" name="id" value="<?php echo $id?>"/>
	<strong>Correo:</strong> <?php echo $row["email"];?>     
  </div>
    
  <div class="campitem dospor">        
    <div class="campb"> <strong>User:</strong>  <?php echo $row["user"];?> </div>   
  </div>

    
  <div class="campitem dospor">        
    <div class="campb"> <strong>Pass:</strong>  <?php echo $row["pass"];?> </div>   
  </div>
