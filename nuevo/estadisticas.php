...
if ($_SESSION["tipo"] == 'vendedor'){	$sql1 = "SELECT * FROM vendedor WHERE id='".$_SESSION["vendedor"]."'";
}else{		$sql1 = "SELECT * FROM vendedor";	};
$result1 = mysql_query($sql1, $conn1);
///$row = mysql_fetch_array($result1);
...
<?php };	 $veces_text = 1;	?>
  ...
  <div class="initem"<?php  if($espaciado == 1){echo 'style="margin-top:15px"';}//para el espaciado entre items
    ...
    <div class="t-progres imgalcost"><?php echo $row["nombre"].' '.$row["apellido"];?></div>  
