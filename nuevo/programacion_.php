...
<div class="bite"><a href="agregar-usuario.php" class="badd">.</a>CLIENTE<?php //echo $dias_cap;?></div>
  <div class="cf"></div><!--
...
if($buscar != ''){
	$sql1 = "SELECT * FROM evento WHERE cliente LIKE '%".$buscar."%' OR  fecha_captura LIKE '%".$buscar."%'  ORDER BY fecha ASC";	
};
$result1 = mysql_query($sql1, $conn1);
...
<span class="titlecol"<?php if(substr($row["fecha"],8,2) != $dia_hoy){echo ' style="margin-top:25px"';};?>><!--PROGRAMACIÓN --><?php echo replacedia_sem($dia_sem);?>
<span class="tcolor"><?php echo ', '.substr($row["fecha"],8,2).' '.replacemes(substr($row["fecha"],5,2));// dia de la semana en texto y numero?>
...
<div class="ic-idel"><a href="eliminar-pedido.php?id=<?php echo $row["id"];?>" target="_self"><img src="delete1.png" width="37" height="37" border="0" /></a></div>
    <?php };?>



    <div class="t-desit imgalcost"> 
    <?php 
    	...
    	if($row5["id"] == $row["id"]){
    ?>
    		<img src="ic-pagado.png" width="37" height="37" border="0" />

    <?php }elseif($row5["checkedeve"] == '1'){?>
    		<img src="ic-envio.png" width="37" height="37" border="0" />
    		
    <?php }else{?>
    		<img src="ic-captura.png" width="37" height="37" border="0" />
    <?php };?>
