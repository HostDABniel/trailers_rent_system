...
<span class="titlecol-ad ades" > PROYECTOS <?php //echo $row7["nombre"].' '.$row7["apellido"];?> </span> 
...
<div class="ic-idel"><a href="agregar-evento.php?id=<?php echo $row5["id"];?>" target="_self"><img src="editaricon.png" width="44" height="44" border="0" /></a></div>
    <?php };?> 
